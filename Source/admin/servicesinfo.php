...
class cservices extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('services', 'services', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title_en
		$this->title_en = new cField('services', 'services', 'x_title_en', 'title_en', '`title_en`', '`title_en`', 200, -1, FALSE, '`title_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title_en'] = &$this->title_en;

		// title_ar
		$this->title_ar = new cField('services', 'services', 'x_title_ar', 'title_ar', '`title_ar`', '`title_ar`', 200, -1, FALSE, '`title_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title_ar'] = &$this->title_ar;

		// brief_en
		$this->brief_en = new cField('services', 'services', 'x_brief_en', 'brief_en', '`brief_en`', '`brief_en`', 200, -1, FALSE, '`brief_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['brief_en'] = &$this->brief_en;

		// brief_ar
		$this->brief_ar = new cField('services', 'services', 'x_brief_ar', 'brief_ar', '`brief_ar`', '`brief_ar`', 200, -1, FALSE, '`brief_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['brief_ar'] = &$this->brief_ar;

		// type
		$this->type = new cField('services', 'services', 'x_type', 'type', '`type`', '`type`', 202, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['type'] = &$this->type;

		// color
		$this->color = new cField('services', 'services', 'x_color', 'color', '`color`', '`color`', 202, -1, FALSE, '`color`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['color'] = &$this->color;

		// desc_en
		$this->desc_en = new cField('services', 'services', 'x_desc_en', 'desc_en', '`desc_en`', '`desc_en`', 201, -1, FALSE, '`desc_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['desc_en'] = &$this->desc_en;

		// desc_ar
		$this->desc_ar = new cField('services', 'services', 'x_desc_ar', 'desc_ar', '`desc_ar`', '`desc_ar`', 201, -1, FALSE, '`desc_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
