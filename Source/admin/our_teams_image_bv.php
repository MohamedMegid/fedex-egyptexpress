...
$our_teams_image_blobview = NULL; // Initialize page object first

class cour_teams_image_blobview extends cour_teams {
	...
	// Page object name
	var $PageObjName = 'our_teams_image_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'our_teams');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('our_teams', 'x_image');
...
// Create page object
if (!isset($our_teams_image_blobview)) $our_teams_image_blobview = new cour_teams_image_blobview();

// Page init
$our_teams_image_blobview->Page_Init();

// Page main
$our_teams_image_blobview->Page_Main();
?>
<?php
$our_teams_image_blobview->Page_Terminate();
?>
