...
//
// Table class for zones
//
class czones extends cTable {
	var $id;
	var $city_en;
	var $city_ar;
	var $zone;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('zones', 'zones', 'x_id', 'id', '`id`', '`id`', 18, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// city_en
		$this->city_en = new cField('zones', 'zones', 'x_city_en', 'city_en', '`city_en`', '`city_en`', 200, -1, FALSE, '`city_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['city_en'] = &$this->city_en;

		// city_ar
		$this->city_ar = new cField('zones', 'zones', 'x_city_ar', 'city_ar', '`city_ar`', '`city_ar`', 200, -1, FALSE, '`city_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['city_ar'] = &$this->city_ar;

		// zone
		$this->zone = new cField('zones', 'zones', 'x_zone', 'zone', '`zone`', '`zone`', 202, -1, FALSE, '`zone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['zone'] = &$this->zone;

		// last_modified
		$this->last_modified = new cField('zones', 'zones', 'x_last_modified', 'last_modified', '`last_modified`', 'DATE_FORMAT(`last_modified`, \'%d/%m/%Y\')', 135, 7, FALSE, '`last_modified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`zones`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("zonesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("zonesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "zonesadd.php?" . $this->UrlParm($parm);
		else
			return "zonesadd.php";
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("zonesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("zonesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("zonesdelete.php", $this->UrlParm());
	}
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->city_en->Exportable) $Doc->ExportCaption($this->city_en);
					if ($this->city_ar->Exportable) $Doc->ExportCaption($this->city_ar);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->city_en->Exportable) $Doc->ExportField($this->city_en);
						if ($this->city_ar->Exportable) $Doc->ExportField($this->city_ar);
