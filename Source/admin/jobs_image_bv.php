...
$jobs_image_blobview = NULL; // Initialize page object first

class cjobs_image_blobview extends cjobs {
	...
	// Page object name
	var $PageObjName = 'jobs_image_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'jobs');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('jobs', 'x_image');
...
// Create page object
if (!isset($jobs_image_blobview)) $jobs_image_blobview = new cjobs_image_blobview();

// Page init
$jobs_image_blobview->Page_Init();

// Page main
$jobs_image_blobview->Page_Main();
?>
<?php
$jobs_image_blobview->Page_Terminate();
?>
