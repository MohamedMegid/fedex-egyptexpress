...
$cms_image_blobview = NULL; // Initialize page object first

class ccms_image_blobview extends ccms {
	...
	// Page object name
	var $PageObjName = 'cms_image_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'cms');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cms', 'x_image');
		...
		// SQL constructor in cms class, cmsinfo.php
...
// Create page object
if (!isset($cms_image_blobview)) $cms_image_blobview = new ccms_image_blobview();

// Page init
$cms_image_blobview->Page_Init();

// Page main
$cms_image_blobview->Page_Main();
?>
<?php
$cms_image_blobview->Page_Terminate();
?>
