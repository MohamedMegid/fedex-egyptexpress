...
class cchangepwd extends cadministrator {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["administrator"]) || get_class($GLOBALS["administrator"]) == "cadministrator") {
			$GLOBALS["administrator"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["administrator"];
		}
		if (!isset($GLOBALS["administrator"])) $GLOBALS["administrator"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'administrator');
