...
$latest_shots_image_blobview = NULL; // Initialize page object first

class clatest_shots_image_blobview extends clatest_shots {
	...
	// Page object name
	var $PageObjName = 'latest_shots_image_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'latest_shots');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('latest_shots', 'x_image');
...
// Create page object
if (!isset($latest_shots_image_blobview)) $latest_shots_image_blobview = new clatest_shots_image_blobview();

// Page init
$latest_shots_image_blobview->Page_Init();

// Page main
$latest_shots_image_blobview->Page_Main();
?>
<?php
$latest_shots_image_blobview->Page_Terminate();
?>
