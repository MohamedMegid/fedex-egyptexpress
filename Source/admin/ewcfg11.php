...
define("EW_PROJECT_NAME", "egyptexpress", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{51AFFC50-D173-42CF-8568-DFD13A65B5CC}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'gY11lRiRF0zhM5zs', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/egyptexpress.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", '172.16.5.199', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'root', TRUE);
define("EW_CONN_PASS", 'password123', TRUE);
define("EW_CONN_DB", 'egyptexpress', TRUE);
...
$EW_XSS_ARRAY = array('javascript', 'vbscript', 'expression', '<applet', '<meta',
...
// File upload
define("EW_UPLOAD_DEST_PATH", "../webroot/uploads/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,xlsx,docx", TRUE); // Allowed file extensions
define("EW_IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp", TRUE); // Allowed file extensions for images
define("EW_MAX_FILE_SIZE", 32000000, TRUE); // Max file size
