...
$home_page_panels_image_blobview = NULL; // Initialize page object first

class chome_page_panels_image_blobview extends chome_page_panels {
	...
	// Page object name
	var $PageObjName = 'home_page_panels_image_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'home_page_panels');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('home_page_panels', 'x_image');
		...
		// SQL constructor in home_page_panels class, home_page_panelsinfo.php
...
// Create page object
if (!isset($home_page_panels_image_blobview)) $home_page_panels_image_blobview = new chome_page_panels_image_blobview();

// Page init
$home_page_panels_image_blobview->Page_Init();

// Page main
$home_page_panels_image_blobview->Page_Main();
?>
<?php
$home_page_panels_image_blobview->Page_Terminate();
?>
