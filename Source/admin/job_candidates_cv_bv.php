...
$job_candidates_cv_blobview = NULL; // Initialize page object first

class cjob_candidates_cv_blobview extends cjob_candidates {
	...
	// Page object name
	var $PageObjName = 'job_candidates_cv_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'job_candidates');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('job_candidates', 'x_cv');
...
// Create page object
if (!isset($job_candidates_cv_blobview)) $job_candidates_cv_blobview = new cjob_candidates_cv_blobview();

// Page init
$job_candidates_cv_blobview->Page_Init();

// Page main
$job_candidates_cv_blobview->Page_Main();
?>
<?php
$job_candidates_cv_blobview->Page_Terminate();
?>
