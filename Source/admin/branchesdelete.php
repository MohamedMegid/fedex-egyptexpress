...
// Page object
var branches_delete = new ew_Page("branches_delete");
branches_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = branches_delete.PageID; // For backward compatibility

// Form object
var fbranchesdelete = new ew_Form("fbranchesdelete");
...
fbranchesdelete.ValidateRequired = true;
<?php } else { ?>
fbranchesdelete.ValidateRequired = false; 
<?php } ?>
...
if ($branches_delete->Recordset = $branches_delete->LoadRecordset())
	$branches_deleteTotalRecs = $branches_delete->Recordset->RecordCount(); // Get record count
if ($branches_deleteTotalRecs <= 0) { // No record found, exit
	if ($branches_delete->Recordset)
		$branches_delete->Recordset->Close();
	$branches_delete->Page_Terminate("brancheslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($branches->id->Visible) { // id ?>
		<th><span id="elh_branches_id" class="branches_id"><?php echo $branches->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($branches->title_en->Visible) { // title_en ?>
		<th><span id="elh_branches_title_en" class="branches_title_en"><?php echo $branches->title_en->FldCaption() ?></span></th>
<?php } ?>
<?php if ($branches->title_ar->Visible) { // title_ar ?>
		<th><span id="elh_branches_title_ar" class="branches_title_ar"><?php echo $branches->title_ar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($branches->lat->Visible) { // lat ?>
		<th><span id="elh_branches_lat" class="branches_lat"><?php echo $branches->lat->FldCaption() ?></span></th>
<?php } ?>
<?php if ($branches->lng->Visible) { // lng ?>
		<th><span id="elh_branches_lng" class="branches_lng"><?php echo $branches->lng->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($branches->id->Visible) { // id ?>
		<td<?php echo $branches->id->CellAttributes() ?>>
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_id" class="form-group branches_id">
...
<?php } ?>
<?php if ($branches->title_en->Visible) { // title_en ?>
		<td<?php echo $branches->title_en->CellAttributes() ?>>
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_title_en" class="form-group branches_title_en">
...
<?php } ?>
<?php if ($branches->title_ar->Visible) { // title_ar ?>
		<td<?php echo $branches->title_ar->CellAttributes() ?>>
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_title_ar" class="form-group branches_title_ar">
...
<?php } ?>
<?php if ($branches->lat->Visible) { // lat ?>
		<td<?php echo $branches->lat->CellAttributes() ?>>
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_lat" class="form-group branches_lat">
...
<?php } ?>
<?php if ($branches->lng->Visible) { // lng ?>
		<td<?php echo $branches->lng->CellAttributes() ?>>
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_lng" class="form-group branches_lng">
