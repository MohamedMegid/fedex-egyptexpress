...
<?php if (!isset($services_view->Pager)) $services_view->Pager = new cNumericPager($services_view->StartRec, $services_view->DisplayRecs, $services_view->TotalRecs, $services_view->RecRange) ?>
<?php if ($services_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($services_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($services_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($services_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $services_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($services_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($services_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
...
<span id="el_services_id" class="form-group">
...
<?php if ($services->title_en->Visible) { // title_en ?>
	<tr id="r_title_en">
		<td><span id="elh_services_title_en"><?php echo $services->title_en->FldCaption() ?></span></td>
		<td<?php echo $services->title_en->CellAttributes() ?>>
<span id="el_services_title_en" class="form-group">
<span<?php echo $services->title_en->ViewAttributes() ?>>
<?php echo $services->title_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->title_ar->Visible) { // title_ar ?>
	<tr id="r_title_ar">
		<td><span id="elh_services_title_ar"><?php echo $services->title_ar->FldCaption() ?></span></td>
		<td<?php echo $services->title_ar->CellAttributes() ?>>
<span id="el_services_title_ar" class="form-group">
<span<?php echo $services->title_ar->ViewAttributes() ?>>
<?php echo $services->title_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->brief_en->Visible) { // brief_en ?>
	<tr id="r_brief_en">
		<td><span id="elh_services_brief_en"><?php echo $services->brief_en->FldCaption() ?></span></td>
		<td<?php echo $services->brief_en->CellAttributes() ?>>
<span id="el_services_brief_en" class="form-group">
<span<?php echo $services->brief_en->ViewAttributes() ?>>
<?php echo $services->brief_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->brief_ar->Visible) { // brief_ar ?>
	<tr id="r_brief_ar">
		<td><span id="elh_services_brief_ar"><?php echo $services->brief_ar->FldCaption() ?></span></td>
		<td<?php echo $services->brief_ar->CellAttributes() ?>>
<span id="el_services_brief_ar" class="form-group">
<span<?php echo $services->brief_ar->ViewAttributes() ?>>
<?php echo $services->brief_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->type->Visible) { // type ?>
	<tr id="r_type">
		<td><span id="elh_services_type"><?php echo $services->type->FldCaption() ?></span></td>
		<td<?php echo $services->type->CellAttributes() ?>>
<span id="el_services_type" class="form-group">
<span<?php echo $services->type->ViewAttributes() ?>>
<?php echo $services->type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->color->Visible) { // color ?>
	<tr id="r_color">
		<td><span id="elh_services_color"><?php echo $services->color->FldCaption() ?></span></td>
		<td<?php echo $services->color->CellAttributes() ?>>
<span id="el_services_color" class="form-group">
<span<?php echo $services->color->ViewAttributes() ?>>
<?php echo $services->color->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->desc_en->Visible) { // desc_en ?>
	<tr id="r_desc_en">
		<td><span id="elh_services_desc_en"><?php echo $services->desc_en->FldCaption() ?></span></td>
		<td<?php echo $services->desc_en->CellAttributes() ?>>
<span id="el_services_desc_en" class="form-group">
<span<?php echo $services->desc_en->ViewAttributes() ?>>
<?php echo $services->desc_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->desc_ar->Visible) { // desc_ar ?>
	<tr id="r_desc_ar">
		<td><span id="elh_services_desc_ar"><?php echo $services->desc_ar->FldCaption() ?></span></td>
		<td<?php echo $services->desc_ar->CellAttributes() ?>>
<span id="el_services_desc_ar" class="form-group">
<span<?php echo $services->desc_ar->ViewAttributes() ?>>
<?php echo $services->desc_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
