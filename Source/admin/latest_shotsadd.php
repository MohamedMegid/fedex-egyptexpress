...
$latest_shots_add = NULL; // Initialize page object first

class clatest_shots_add extends clatest_shots {
	...
	// Page object name
	var $PageObjName = 'latest_shots_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("latest_shotslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "latest_shotsview.php")
...
// Create page object
if (!isset($latest_shots_add)) $latest_shots_add = new clatest_shots_add();

// Page init
$latest_shots_add->Page_Init();

// Page main
$latest_shots_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$latest_shots_add->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var latest_shots_add = new ew_Page("latest_shots_add");
latest_shots_add.PageID = "add"; // Page ID
var EW_PAGE_ID = latest_shots_add.PageID; // For backward compatibility

// Form object
var flatest_shotsadd = new ew_Form("flatest_shotsadd");

// Validate form
flatest_shotsadd.Validate = function() {
...
flatest_shotsadd.Form_CustomValidate = 
...
flatest_shotsadd.ValidateRequired = true;
<?php } else { ?>
flatest_shotsadd.ValidateRequired = false; 
<?php } ?>
...
<?php $latest_shots_add->ShowPageHeader(); ?>
<?php
$latest_shots_add->ShowMessage();
?>
<form name="flatest_shotsadd" id="flatest_shotsadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($latest_shots_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $latest_shots_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
flatest_shotsadd.Init();
</script>
<?php
$latest_shots_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$latest_shots_add->Page_Terminate();
?>
