...
$home_page_panels = NULL;

//
// Table class for home_page_panels
//
class chome_page_panels extends cTable {
	var $id;
	var $image;
	var $url;
	var $title_en;
	...
	function __construct() {
		...
		$this->TableVar = 'home_page_panels';
		$this->TableName = 'home_page_panels';
		...
		// id
		$this->id = new cField('home_page_panels', 'home_page_panels', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// image
		$this->image = new cField('home_page_panels', 'home_page_panels', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['image'] = &$this->image;

		// url
		$this->url = new cField('home_page_panels', 'home_page_panels', 'x_url', 'url', '`url`', '`url`', 200, -1, FALSE, '`url`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['url'] = &$this->url;

		// title_en
		$this->title_en = new cField('home_page_panels', 'home_page_panels', 'x_title_en', 'title_en', '`title_en`', '`title_en`', 200, -1, FALSE, '`title_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title_en'] = &$this->title_en;

		// title_ar
		$this->title_ar = new cField('home_page_panels', 'home_page_panels', 'x_title_ar', 'title_ar', '`title_ar`', '`title_ar`', 200, -1, FALSE, '`title_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title_ar'] = &$this->title_ar;

		// brief_en
		$this->brief_en = new cField('home_page_panels', 'home_page_panels', 'x_brief_en', 'brief_en', '`brief_en`', '`brief_en`', 200, -1, FALSE, '`brief_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['brief_en'] = &$this->brief_en;

		// brief_ar
		$this->brief_ar = new cField('home_page_panels', 'home_page_panels', 'x_brief_ar', 'brief_ar', '`brief_ar`', '`brief_ar`', 200, -1, FALSE, '`brief_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['brief_ar'] = &$this->brief_ar;

		// last_modified
		$this->last_modified = new cField('home_page_panels', 'home_page_panels', 'x_last_modified', 'last_modified', '`last_modified`', 'DATE_FORMAT(`last_modified`, \'%d/%m/%Y\')', 135, 7, FALSE, '`last_modified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`home_page_panels`";
	}
	...
	// Update Table
	var $UpdateTable = "`home_page_panels`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "home_page_panelslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("home_page_panelsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("home_page_panelsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "home_page_panelsadd.php?" . $this->UrlParm($parm);
		else
			return "home_page_panelsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("home_page_panelsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("home_page_panelsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("home_page_panelsdelete.php", $this->UrlParm());
	}
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->brief_en->Exportable) $Doc->ExportCaption($this->brief_en);
					if ($this->brief_ar->Exportable) $Doc->ExportCaption($this->brief_ar);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->brief_en->Exportable) $Doc->ExportField($this->brief_en);
						if ($this->brief_ar->Exportable) $Doc->ExportField($this->brief_ar);
