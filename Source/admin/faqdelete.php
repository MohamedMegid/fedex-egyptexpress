...
?>
<form name="ffaqdelete" id="ffaqdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($faq_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $faq_delete->Token ?>">
<?php } ?>
...
<?php if ($faq->id->Visible) { // id ?>
		<th><span id="elh_faq_id" class="faq_id"><?php echo $faq->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($faq->question_en->Visible) { // question_en ?>
		<th><span id="elh_faq_question_en" class="faq_question_en"><?php echo $faq->question_en->FldCaption() ?></span></th>
<?php } ?>
<?php if ($faq->question_ar->Visible) { // question_ar ?>
		<th><span id="elh_faq_question_ar" class="faq_question_ar"><?php echo $faq->question_ar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($faq->last_modified->Visible) { // last_modified ?>
		<th><span id="elh_faq_last_modified" class="faq_last_modified"><?php echo $faq->last_modified->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $faq_delete->RowCnt ?>_faq_id" class="form-group faq_id">
<span<?php echo $faq->id->ViewAttributes() ?>>
<?php echo $faq->id->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($faq->question_en->Visible) { // question_en ?>
		<td<?php echo $faq->question_en->CellAttributes() ?>>
<span id="el<?php echo $faq_delete->RowCnt ?>_faq_question_en" class="form-group faq_question_en">
<span<?php echo $faq->question_en->ViewAttributes() ?>>
<?php echo $faq->question_en->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($faq->question_ar->Visible) { // question_ar ?>
		<td<?php echo $faq->question_ar->CellAttributes() ?>>
<span id="el<?php echo $faq_delete->RowCnt ?>_faq_question_ar" class="form-group faq_question_ar">
<span<?php echo $faq->question_ar->ViewAttributes() ?>>
<?php echo $faq->question_ar->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($faq->last_modified->Visible) { // last_modified ?>
		<td<?php echo $faq->last_modified->CellAttributes() ?>>
<span id="el<?php echo $faq_delete->RowCnt ?>_faq_last_modified" class="form-group faq_last_modified">
<span<?php echo $faq->last_modified->ViewAttributes() ?>>
<?php echo $faq->last_modified->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
