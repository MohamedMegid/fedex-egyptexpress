...
class cslider_view extends cslider {
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_slider\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_slider',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fsliderview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
<?php if (!isset($slider_view->Pager)) $slider_view->Pager = new cNumericPager($slider_view->StartRec, $slider_view->DisplayRecs, $slider_view->TotalRecs, $slider_view->RecRange) ?>
<?php if ($slider_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($slider_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $slider_view->PageUrl() ?>start=<?php echo $slider_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($slider_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $slider_view->PageUrl() ?>start=<?php echo $slider_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($slider_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $slider_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($slider_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $slider_view->PageUrl() ?>start=<?php echo $slider_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($slider_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $slider_view->PageUrl() ?>start=<?php echo $slider_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
...
<span id="el_slider_id" class="form-group">
...
<span id="el_slider_image" class="form-group">
<span>
<?php echo ew_GetFileViewTag($slider->image, $slider->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
