...
class MY_Lang extends CI_Lang {
   ...
   function default_lang()
   {
      ...
      $browser_lang = $this->lang(); // set explicit language not from browser
      return (array_key_exists($browser_lang, $this->languages)) ? $browser_lang : $this->lang();
   }
      ...
      if($load_first_lang)
      {
         ...
         if($this->lang_code != $firstKey)
         {
            ...
            if($addedLang)
            {
               ...
               $this->is_loaded = array_diff($this->is_loaded, array(
                              $langfileToRemove));
            }
         }
      }
